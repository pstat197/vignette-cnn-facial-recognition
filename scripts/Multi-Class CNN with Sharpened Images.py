...
# ### Model Preformance on Sharpened Images
# The following cell uses the package OpenCV to blur each image and then add it back into the training and testing data
